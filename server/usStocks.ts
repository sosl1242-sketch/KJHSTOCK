...
const stocks: BaseUsStock[] = [
  ...
  { rank: 200, ticker: "DVLT", name: "Datavault AI", sector: "클라우드·소프트웨어", exchange: "NASDAQ", price: 0.49, change1dPercent: -5.65, change5dPercent: -8.2, marketCapUsd: 345000000, revenueTtmUsd: 39090000, grossMarginPercent: 22.4, operatingMarginPercent: -180.0, epsTtm: -0.52, peRatio: null, forwardPeRatio: null, priceToSalesRatio: 8.8, priceToBookRatio: null, dividendYieldPercent: 0.0, beta: 0.36, analystUpsidePercent: 506.6 },
];
